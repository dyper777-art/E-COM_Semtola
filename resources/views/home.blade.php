...
@section('content')
    ...
    <section class="hero">
        <div class="container">
            <h2>Welcome to</h2>
            <h1 class="fw-bold text-success">TEEN.</h1>
            <p>We are a family-run Japanese tea company founded in 1717, in the heart of
                ...
                <br>teas by carefully selecting, blending, and crafting each of our 30+ blends.
            </p>
        </div>
    </section>
                ...
                <div class="product-grid">
                    @foreach ($products as $index => $product)
                        <div class="product-card">
                            <img class="imagesize" src="{{ asset('images/product/' . $product['image']) }}"
                                alt="{{ $product['name'] }}">
                            ...
                            <form action="{{ route('cart.add', $product['id']) }}" method="POST">
                                ...
                                <button type="button" class="btn-view"
                                    onclick="openModal({{ $product['id'] }})">View</button>
                            </form>
                        </div>
                    @endforeach
                </div>
